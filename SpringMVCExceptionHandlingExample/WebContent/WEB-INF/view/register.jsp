...
<form:errors path="student.*"></form:errors>
	<form:form action="/SpringMVCExceptionHandlingExample/registerSuccess"
		method="post" modelAttribute="student">
		<h2 align="center"><spring:message code="label.register.header"/></h2>
		<h3 align="center"><a href="/SpringMVCExceptionHandlingExample?lang=en">English</a> | <a href="/SpringMVCExceptionHandlingExample?lang=fr">French</a></h3>
		<table align="center">
