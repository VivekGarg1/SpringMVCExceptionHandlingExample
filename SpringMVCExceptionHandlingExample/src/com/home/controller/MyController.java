...
public class MyController {
	...
	public ModelAndView registerSuccess(@ModelAttribute("student") Student student, BindingResult bindingResult) throws Exception {
		/*if(student.getStudentName().isEmpty()) {
			throw new RuntimeException();
		}*/
		//If generic checked exception present
